...
// ### LH - 23.10.2008: uncomment this if you dont want to list
//                      loopback devices.
//                      i want to list them for local sending / receiving on Linux
...
typedef struct {
  ...
  int ar_count;
  int verbose;
  // ### LH - new properties for additional features
  int  bind2Ip ;     // ### LH - bind socket to the given ip_addr ?
	int  reuse ;       // ### LH - reuse IP port ?
  //bool allowAllIf ;  // ### LH - 23.10.2008: Allow all types of interface ? (loopback ...)
  SI   bCastForce ;  // ### LH - another broadcast-address than default
