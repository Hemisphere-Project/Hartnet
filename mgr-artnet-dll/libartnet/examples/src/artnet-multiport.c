 ...
 * We need a way to share the socket bound to the broadcast address
 * between two nodes.
 *
 * Further only one node can read from the broadcast socket
 * and it needs to *pass* ? the data to the other node.
 *
...
int main(int argc, char *argv[]) {
    ...
    node2 = artnet_new("10.0.0.100", verbose) ; ;
